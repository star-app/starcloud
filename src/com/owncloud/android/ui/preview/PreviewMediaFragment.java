 ...
 * 
 * Trying to get an instance with NULL {@link OCFile} or ownCloud
 * {@link Account} values will produce an {@link IllegalStateException}.
 * 
 * By now, if the {@link OCFile} passed is not downloaded, an
 * {@link IllegalStateException} is generated on instantiation too.
 * 
 * @author David A. Velasco
 */
@SuppressLint("ValidFragment")
public class PreviewMediaFragment extends SherlockFragment implements OnTouchListener, FileFragment,
...
*/    public static final String EXTRA_FILE = "FILE";
    ...
    public PreviewMediaFragment(OCFile fileToDetail, Account ocAccount) {
        ...
        mStorageManager = null; // we need a context to init this; the container
                                // activity is not available yet at this moment
        mAutoplay = true;
    }
     ...
     * automatically (for instance, when the device is turned a aside).
     * 
     * DO NOT CALL IT: an {@link OCFile} and {@link Account} must be provided
     * for a successful construction
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       /* // ///////////////////////////
        ...
        mImagePreview.setImageBitmap(bitmap);// 填充控件
        mImagePreview.setOnTouchListener(this);// 设置触屏监听
        dm = new DisplayMetrics();
//        getWindowManager().getDefaultDisplay().getMetrics(dm);// 获取分辨率
        minZoom();
        center();
        mImagePreview.setImageMatrix(matrix);
...
*/
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mStorageManager = new FileDataStorageManager(mAccount, getActivity().getApplicationContext()
                .getContentResolver());
    ...
    private void playVideo() {
        ...
        // VideoHelper#onPrepared() will be called
    ...
    private void bindMediaService() {
        ...
        getActivity().bindService(new Intent(getActivity(), MediaService.class), mMediaServiceConnection,
        ...
        public void onServiceConnected(ComponentName component, IBinder service) {
            if (component.equals(new ComponentName(getActivity(), MediaService.class))) {
                ...
                if (mMediaServiceBinder != null) {
                    ...
                    playAudio(); // do not wait for the touch of nobody to play
                                 // audio
            ...
            if (component.equals(new ComponentName(getActivity(), MediaService.class))) {
                ...
                if (mMediaController != null) {
                    ...
                    Toast.makeText(getActivity(),
                            "No media controller to release when disconnected from media service", Toast.LENGTH_SHORT)
                            .show();
                }
                mMediaServiceBinder = null;
                mMediaServiceConnection = null;
     ...
     * 
     * TODO - improve this; instead of prioritize the actions available for the
     * MIME type in the server, we should get a list of available apps for MIME
     * tpye in the server and join it with the list of available apps for the
     * MIME type known from the file extension, to let the user choose
     */
    private void openFile() {
        ...
        try {
            ...
            try {
                ...
                if (toastIt) {
                    Toast.makeText(getActivity(), "There is no application to handle file " + mFile.getFileName(),
     ...
     * 
     * Shows a confirmation dialog. The action continues in
     * {@link #onConfirmation(String)} , {@link #onNeutral(String)} or
     * {@link #onCancel(String)}, depending upon the user selection in the
     * dialog.
     */
    ...
    /**
     * Performs the removal of the previewed file, both locally and in the
     * server.
     */
    @Override
    public void onConfirmation(String callerTag) {
        if (mStorageManager.getFileById(mFile.getFileId()) != null) { // check
                                                                      // that
                                                                      // the
                                                                      // file is
                                                                      // still
                                                                      // there;
            stopPreview(true);
            mLastRemoteOperation = new RemoveFileOperation(mFile, // TODO we
                                                                  // need to
                                                                  // review the
                                                                  // interface
                                                                  // with
            ...
            WebdavClient wc = OwnCloudClientUtils.createOwnCloudClient(mAccount, getSherlockActivity()
    ...
    /*
     * /** Use this method to signal this Activity that it shall update its
     * view.
     * 
     * @param file : An {@link OCFile}-/ public void updateFileDetails(OCFile
     * file, Account ocAccount) { mFile = file; if (ocAccount != null && (
     * mStorageManager == null || (mAccount != null &&
     * !mAccount.equals(ocAccount)) )) { mStorageManager = new
     * FileDataStorageManager(ocAccount,
     * getActivity().getApplicationContext().getContentResolver()); } mAccount =
     * ocAccount; updateFileDetails(false); }
     */

    /**
     * Helper method to test if an {@link OCFile} can be passed to a
     * {@link PreviewMediaFragment} to be previewed.
     * 
    ...
    protected void center(boolean horizontal, boolean vertical) {
        ...
        if (vertical) {
            ...
            if (height < screenHeight) {
                ...
                deltaY = mImagePreview.getHeight() - rect.bottom;
            }
        }
